...
wget.download("https://cleanlab-public.s3.amazonaws.com/RegressionBenchmark/label_aggregation_random.csv",out=output_directory)
...
wget.download("https://cleanlab-public.s3.amazonaws.com/RegressionBenchmark/metaphor_novelity_random.csv",out=output_directory)

...
# Modified: Mayank Kumar 
# Code is modified to consider the custom loss function for RANSACRegressor. 
# Custom loss function should take only 2 arguments i.e., labels, predictions.  
# #MODIFIED is added in section of code where modification has been done. 
...
class RANSACRegressor(
    ...
    _parameter_constraints: dict = {
        ...
        "percentile_outlier": [Interval(Real, 0, 100, closed="both"), None],
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        while self.n_trials_ < max_trials:
            ...
            if isinstance(self.loss, str):
                # this will be used if using default methods like absolute_error and squared_error as loss
                # by default threshold is calculated based on MAD. 
                inlier_mask_subset = residuals_subset <= residual_threshold
            
            elif not isinstance(self.loss, str):
                # As our scores are expected to be between 0 and 1, with 1 representing good label. 
                # Inliers will be datapoints with scores greater than threshold. 
                inlier_mask_subset = residuals_subset >= residual_threshold
